...
| `rollback.sh` | Required | Manual rollback and uninstall | Resets runtime state, clears imported Bluetooth contacts/call-log provider data, removes Bluetooth cache/logs, and disables the module. Keep. |
